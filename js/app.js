...
document.addEventListener("DOMContentLoaded", () => {
  ...
  Agents.map((item)=>{
   ...
   <div class="flex gap-5 text-white text-sm justify-center">
   
    <div class=" bg-[#00204a] border-2 hover:border-[#00204a]  hover:bg-white hover:text-[#00204a] py-3 px-[13px] rounded-full">
